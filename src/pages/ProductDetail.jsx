    ...
    <Layout>
          ...
          >
            ...
            {product.seller?.primaryTag && (
              <span
                style={{
                  background:
                    product.seller?.kycLevel >= 3 ? T.jadeBg : T.surfaceAlt,
              ...
              >
                {product.seller?.kycLevel >= 3 && <BadgeCheck size={11} />}{" "}
                {product.seller.primaryTag}
              </span>
            )}
          </div>
          <div style={{ fontSize: 12, color: T.textDim }}>
            {product.seller?.kycLevel >= 3 ? "Verified · " : "Unverified · "}
      ...
      {product.seller?.kycLevel < 3 && (
        ...
        >
          ...
          <span>
            This seller hasn't completed identity verification. Your payment is
            still protected by PaxeL escrow, but we recommend trading with added
            caution and reviewing details closely before you confirm.
          </span>
        </div>
      )}
